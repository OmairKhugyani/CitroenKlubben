...
<div class="container container-lg box-bg-gradient">
  ...
  <main class="box-content-padding">
    ...
    <div class="container_space-around margin-bottom-1">
      ...
      <a class="link-remove btn"><svg class="svg-user-more"></svg>Alle klubber</a>
    </div>
    ...
    <div class="container_space-around margin-bottom-1">
      ...
      <a class="link-remove btn btn-white-redhover"><svg class="svg-user-remove"></svg>Fjen medlem</a>
    </div>
